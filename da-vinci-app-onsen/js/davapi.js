...
app.davinciApi = {
  ...
  // Comunicati
  getComunicatiStudenti: (last_n = 30) => axios.get(app.davinciApi.apiUrl+"comunicati/studenti/"+last_n),
  getComunicatiGenitori: (last_n = 30) => axios.get(app.davinciApi.apiUrl+"comunicati/genitori/"+last_n),
  getComunicatiDocenti : (last_n = 30) => axios.get(app.davinciApi.apiUrl+"comunicati/docenti/"+last_n),
